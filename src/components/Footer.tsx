    ...
    <footer className="bg-ink text-white/80">
      <div className="container-pro py-20 grid md:grid-cols-12 gap-10">
        <div className="md:col-span-5">
          ...
          <p className="mt-6 max-w-sm text-sm leading-relaxed text-white/55">
            Inmobiliaria en Canning. Propiedades, inversiones y desarrollos con
            asesoramiento integral y visión estratégica.
          </p>
        </div>

        <div className="md:col-span-3">
          <div className="text-[0.65rem] tracking-[0.22em] uppercase text-white/40 font-semibold mb-5">Navegación</div>
        ...
        <div className="md:col-span-4">
          <div className="text-[0.65rem] tracking-[0.22em] uppercase text-white/40 font-semibold mb-5">Contacto</div>
          <address className="not-italic text-sm leading-relaxed space-y-2">
            ...
            <div>
              <a href="https://instagram.com/marinprop" target="_blank" rel="noopener noreferrer" className="hover:text-white transition-colors">
                @marinprop
              </a>
            </div>
          </address>
      ...
      <div className="border-t border-white/10">
        <div className="container-pro py-6 flex flex-col md:flex-row items-center justify-between gap-3 text-[0.7rem] text-white/40">
          <div>© {new Date().getFullYear()} Marin Propiedades. Todos los derechos reservados.</div>
